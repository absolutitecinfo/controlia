        ...
        <Card className="border-border hover:border-primary transition-smooth card-hover-glow">
          ...
          <CardContent>
            <div className="space-y-4">
              {[1, 2, 3, 4].map((item) => (
                <div key={item} className="flex items-center gap-4 hover:bg-muted/50 p-2 rounded-lg transition-smooth cursor-pointer">
          ...
          <CardContent>
            <div className="space-y-4">
              {["API Gateway", "Banco de Dados", "Serviços IA", "Storage"].map((service) => (
                <div key={service} className="flex items-center justify-between hover:bg-muted/50 p-2 rounded-lg transition-smooth">
