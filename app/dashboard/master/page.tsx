    ...
    <div className="space-y-8">
        ...
        {platformStats.map((stat, index) => (
          <Card key={index} className="border-border hover:border-primary transition-smooth card-hover-glow">
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
              ...
              <stat.icon className="h-5 w-5 text-primary transition-smooth" />
            </CardHeader>
            <CardContent>
      ...
      <Tabs defaultValue="subscriptions" className="space-y-6">
        <TabsList className="bg-muted">
          <TabsTrigger value="subscriptions" className="data-[state=active]:text-primary">Assinaturas</TabsTrigger>
          <TabsTrigger value="growth" className="data-[state=active]:text-primary">Crescimento</TabsTrigger>
        </TabsList>
        ...
        <TabsContent value="growth" className="space-y-6">
          ...
          <div className="grid gap-6 md:grid-cols-3">
            <Card className="border-border hover:border-primary transition-smooth card-hover-glow">
              <CardHeader>
                <CardTitle className="flex items-center gap-2">
                  <Activity className="h-5 w-5 text-primary transition-smooth" />
                  Churn Rate
                </CardTitle>
              </CardHeader>
              <CardContent>
            ...
            <Card className="border-border hover:border-primary transition-smooth card-hover-glow">
              <CardHeader>
                <CardTitle className="flex items-center gap-2">
                  <TrendingUp className="h-5 w-5 text-primary transition-smooth" />
                  LTV Médio
                </CardTitle>
              </CardHeader>
              <CardContent>
            ...
            <Card className="border-border hover:border-primary transition-smooth card-hover-glow">
              <CardHeader>
                <CardTitle className="flex items-center gap-2">
                  <DollarSign className="h-5 w-5 text-primary transition-smooth" />
                  CAC
                </CardTitle>
              </CardHeader>
              <CardContent>
